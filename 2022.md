...
* **Chinchilla** (**Chinchilla**)
  ...
  * problem and position: empirical analysis on training LLM scaling law
  * method overview: given a fixed FLOPS/compute budget, model size and number of training tokens should be scaled equally ~20x, instead of only scaling model size
