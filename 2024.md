...
* **Visual AutoRegressive Modeling** (**VAR**)
  * title and link: [Visual Autoregressive Modeling: Scalable Image Generation via Next-Scale Prediction](https://arxiv.org/abs/2404.02905)
  ...
  * teaser: 
    ![VAR_teaser](assets/2024/VAR_teaser.png)
  * results: beat diffusion, scaling law
    ![VAR_result](assets/2024/VAR_result.png)
  * method details: 
    ...
    * decoder-only Transformer like GPT-2 for next-scale prediction
    ![VAR_method](assets/2024/VAR_method.png)

* **Open-source VLA** (**OpenVLA**)
  * title and link: [OpenVLA: An Open-Source Vision-Language-Action Model](https://arxiv.org/abs/2406.09246)
  ...
  * results: beat RT-X when zero-shot or finetuning
    ![OpenVLA_result](assets/2024/OpenVLA_result.png)
  * method details: 
    ...
    * open source
    ![OpenVLA_method](assets/2024/OpenVLA_method.png)

* **From Speaker to Dubber** (**speaker2dubber**)
  * title and link: [From Speaker to Dubber: Movie Dubbing with Prosody and Duration Consistency Learning](https://dl.acm.org/doi/10.1145/3664647.3680777)
  ...
  * method overview: first multi-task speaker pre-training, second prosody consistency learning and duration consistency reasoning
    ![speaker2dubber_method](assets/2024/speaker2dubber_method.png)
  * teaser: 
    ![speaker2dubber_teaser](assets/2024/speaker2dubber_teaser.png)
  * results: 
    ![speaker2dubber_result](assets/2024/speaker2dubber_result.png)

* **Harmonic Mobile Manipulation** (**HarmonicMM**)
  * title and link: [Harmonic Mobile Manipulation](https://arxiv.org/abs/2312.06639)
  ...
  * method overview: RGB images input and base+arm actions output, train by DD-PPO in ProcTHOR
    ![HarmonicMM_method](assets/2024/HarmonicMM_method.png)
  * results: 
    ![HarmonicMM_result](assets/2024/HarmonicMM_result.png)

* **Minimalist Vision** (**MinimalistVision**)
  * title and link: [Minimalist Vision with Freeform Pixels](https://arxiv.org/abs/2501.00142)
  ...
  * method overview: freeform pixels as the first layer of network for training, deployed by learned optical masks and photodetectors
    ![MinimalistVision_method](assets/2024/MinimalistVision_method.png)
  * teaser: 
    ![MinimalistVision_teaser](assets/2024/MinimalistVision_teaser.png)
